    ...
    <div className={styles.contactMain}>
      ...
      <div className={styles.leftPortion}>
        ...
        <p className={styles.text}>
          ...
          observable. As a result, we must often infer the reasons why people do
      ...
      <div className={styles.rightPortion}>
        ...
        <p className={styles.text}>
          ...
          goal-directed actions. Although, such motives are rarely directly
          observable. As a result, we must often infer the reasons why people do
          the things that they do based on observable behaviors Motivation also
          involves factors
        </p>
        <p className={styles.text}>
          {" "}
            ...
            <div key={index} className={styles.cardMain}>
              ...
              <div className={styles.cardContent}>
                ...
                <p className={styles.cardText}>
                  ...
                  Motivation also involves factors that direct and maintain
                  goal-directed actions. Although, such motives are rarely
                  directly observable. As a result, we must often infer the such
                  motives are rarely directly
                </p>
                {/* ====> bottom line */}
